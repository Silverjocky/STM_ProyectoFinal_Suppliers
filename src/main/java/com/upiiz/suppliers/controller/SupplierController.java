...
@RestController
@CrossOrigin(origins = {"http://localhost:4200", "https://stm-proyectofinal-suppliers.onrender.com"}, methods = {RequestMethod.GET, RequestMethod.POST, RequestMethod.PUT, RequestMethod.DELETE})
